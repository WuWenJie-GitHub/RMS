 ...
 */
package org.tangdao.common.web.http;
...
public class HttpClientUtils {
    ...
    public static String get(String url) {
        ...
        RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(CONNECTION_REQUEST_TIMEOUT).setConnectTimeout(CONNECTION_TIMEOUT).setSocketTimeout(SOCKET_READ_TIMEOUT).build();
     ...
     * @return
     */
    public static HttpPost getHttpPost(String url, int conectionRequestTimeout, int connectionTimeout, int socketTimeout) {
        HttpPost httpPost = new HttpPost(url);

        RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(conectionRequestTimeout).setConnectTimeout(connectionTimeout).setSocketTimeout(socketTimeout).build();
    ...
    public static String post(String url, Map<String, Object> headers, Map<String, Object> params, Integer maxTotal,
        ...
        try {
            ...
            httpClient = HttpClientUtils.getHttpClient(url, maxTotal, maxPerRoute);
            // 提交post请求
    ...
    public static String postReport(String url, String content, String encoding, Map<String, Object> headers) {
        ...
        CloseableHttpClient httpClient = null;
        try {
            httpClient = HttpClientUtils.getHttpClient(url, DEFAULT_MAX_TOTAL, DEFAULT_MAX_PER_ROUTE);
