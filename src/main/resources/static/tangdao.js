...
$(function() {
    ...
    $(document).on("click", ".addTabPage", function(e) {
        ...
        if (href && href != "" && href != "blank") {
            js.addTabPage($this, $.trim(title || "新标签"), href);
...
(function($, window, undefined) {
    ...
    var js = {
        ...
        getAjaxErrMsg:function(data, message){
            if(message) return message;
            if(data.responseText==""){
                data.responseText = data.status+" - " + data.statusText
            }
        ...
        confirm: function(message, urlOrFun, data, callback, dataType, async, loadingMessage) {
            ...
            var sendAjax = function() {
                ...
                $.ajax({
                    ...
                    error: function(data) {
                        js.showErrorMessage(js.getAjaxErrMsg(data));
